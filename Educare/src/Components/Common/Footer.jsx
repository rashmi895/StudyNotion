...
const Footer = () => {
  return (
    <div className="w-full bg-orange-950 text-white">
      <div className="flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-white leading-6 mx-auto relative py-14">

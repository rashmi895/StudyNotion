...
import logo from "../../assets/Logos/websiteLogo.png"
      ...
      <nav>
                        ...
                        link.title === "Catalog" ? (
                            <div className='relative flex items-center gap-2 group'>
                                ...
                                <div className={`invisible absolute left-[50%] 
                                 ...
                                 top-[50%] z-50 
                                flex flex-col rounded-md bg-richblack-5 p-4 text-white
                                    ...
                                    subLinks.length ? (
                                            subLinks.map( (subLink, index) => (
                                                <Link
                                                    ...
                                                    to={`catalog/${subLink.name.trim().toLowerCase().replace(/\s+/g, "-")}`}
                                                    key={index}
                                                >
                                                    <p>{subLink.name}</p>
                                                </Link>
        ...
        <div className='hidden md:flex gap-x-4 items-center'>
            ...
            }
            {
                token === null && (
                    <Link to="/login">
                        <button className='border  border-richblack-700 bg-richblack-800 px-[12px] py-[8px] text-white rounded-md'>
                            Log in
                        </button>
                    </Link>
                )

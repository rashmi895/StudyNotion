    ...
    <>
        ...
        <div className='relative w-full bg-richblack-800'>
            <div className='mx-auto box-content px-4 lg:w-[1260px] 2xl:relative '>
                <div className='mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]'>
                   ...
                   <div className='flex w-full flex-col gap-4 border-y border-y-richblack-500 py-4 text-white lg:hidden'>
        ...
        <div className='mx-auto box-content px-4 text-start text-white lg:w-[1260px]'>
            <div className='mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]'>
                ...
                <p className='text-3xl font-semibold text-white'> What You WIll learn</p>
                ...
                <div className='max-w-[830px] '>
                    ...
                    <div className='py-4'>
                        {
                            courseContent.map((section) => (
                                <div key={section._id} className='overflow-hidden border border-solid border-richblack-600 bg-richblack-700 text-white last:mb-0'>
                                    {/* Section */}
                                    ...
                                    <div className={` ${isActive.includes(section._id) ? 'h-[88px]' : ''} relative h-0 overflow-hidden bg-richblack-900 transition-[height] duration-[0.35s] ease-[ease]`}>
                                        {section.subSection.map((subSection)=> (
                                                <div key={subSection._id} className='flex flex-col gap-2 px-7 py-6 font-semibold text-white'>
                    ...
                    <div className='mb-12 py-4'>
                        <p className="text-[28px] font-semibold text-white">Author</p>
                        <div className=' flex items-center gap-4 py-4'>
                            <img className='h-14 w-14 rounded-full object-cover' src={instructor.image}/>
                            <p className='text-lg text-white'>{instructor.firstName} {instructor.lastName}  </p>
                        </div>
